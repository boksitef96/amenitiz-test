...
class BulkDiscountService implements DiscountTypeInterface
{
    ...
    public function applyDiscount(array $productData, Discount $discountData): array
    {
        ...
        $newPrice = $productData['totalPrice'] * (1 - ($discountData->getAdditionalData()?->getDiscountPercent() / 100));
        ...
        $productData['appliedDiscounts'][] = DiscountTypeEnum::BULK_DISCOUNT->value; // Log applied discount
